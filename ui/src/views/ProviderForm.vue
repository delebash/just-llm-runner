...
<template>
  <div class="lu-pform">
    ...
    <div v-if="isBuiltin" class="lu-pf-libs">
      <UiButton intent="secondary" size="small" @click="showClassTunes = true">PC class configs…</UiButton>
    ...
    <AppModal v-if="showClassTunes" title="PC class configs — the library"
