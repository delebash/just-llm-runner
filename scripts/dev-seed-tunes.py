...
"""Dev-only: restore the author box's measured tunes after a data reset — NOT part of
any product seed (user decision 2026-07-06: "i agree it should not be a defualt seed
for everyone"; tunes are measurements owned by each (model, machine) pair).
