...
// The gate REMOVAL (ruled 2026-08-06, "no fancy magic"): thinking is sent
// exactly as configured — no inactive state exists; a provider that can't
// take the parameter answers with its own error plus the fix pointer.
