...
"""The ONE reasoning resolver (house-layering rewrite 2026-07-16): the ask (think + level)
→ what each provider/model emits. LOCAL reads the layered `reasoning_budget` SWITCH value
...
non-numeric → invalid). CLOUD levels come from the per-provider reasoning_map."""
import pytest
