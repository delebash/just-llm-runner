...
>
> 🔁 **ROUTER DECISION (2026-06-29, user-confirmed):** this doc's "router mode" recommendation was RESOLVED the other way — **stay spawn-per-model + stock llama.cpp; router deferred** (low-VRAM trap + 1-model common case; Kobold/Tabby/Aphrodite evaluated + rejected). Rationale: `2026-06-29-knob-catalog-expansion.md` §DECISION.
